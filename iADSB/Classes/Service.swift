...
public struct IADSB {
    ...
    public class Service: Comparable {
        ...
        // services 
        public var device:IADSB.Device?
        ...
        public static func < (lhs: IADSB.Service, rhs: IADSB.Service) -> Bool {
            return lhs.lessThan( rhs )
        }
        public func lessThan(_ rhs: IADSB.Service) -> Bool {
        ...
        public func isEqual(_ rhs: IADSB.Service) -> Bool {
